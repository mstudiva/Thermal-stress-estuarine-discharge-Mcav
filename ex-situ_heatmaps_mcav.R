...
pdf(file="heatmap_colony_0.05.pdf", height=90, width=90)
...
pdf(file="heatmap_colony_0.01.pdf", height=60, width=90)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=colony$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_colony_0.001.pdf", height=30, width=90)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=colony$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_colony_1e-9.pdf", height=10, width=25)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=colony$pvalue, # metric of gene significance
           cutoff=1E-9, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_temp_0.05.pdf", height=90, width=90)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
...
pdf(file="heatmap_temp_0.01.pdf", height=60, width=90)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=temp$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_temp_0.001.pdf", height=45, width=90)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=temp$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_temp_1e-9.pdf", height=10, width=25)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=temp$pvalue, # metric of gene significance
           cutoff=1E-9, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_water_0.05.pdf", height=30, width=40)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
...
pdf(file="heatmap_water_0.01.pdf", height=15, width=20)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=water$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_water_0.001.pdf", height=4, width=20)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=water$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_tw_0.05.pdf", height=15, width=30)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
...
pdf(file="heatmap_tw_0.01.pdf", height=6, width=30)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=tw$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_tw_0.001.pdf", height=3, width=30)
uniHeatmap(vsd=vsd.tw,gene.names=gg,
           metric=tw$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
