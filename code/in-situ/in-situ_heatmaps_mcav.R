...
pdf(file="heatmap_time_0.05.pdf", height=90, width=27)
...
pdf(file="heatmap_time_0.01.pdf", height=65, width=27)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=time$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_time_0.001.pdf", height=30, width=18)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=time$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_time_1e-6.pdf", height=4.5, width=10)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=time$pvalue, # metric of gene significance
           cutoff=1E-6, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_site_0.05.pdf", height=30 , width=33)
uniHeatmap(vsd=vsd,gene.names=gg,
...
pdf(file="heatmap_site_0.01.pdf", height=12, width=18)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=site$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_site_0.001.pdf", height=6, width=9)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=site$pvalue, # metric of gene significance
           cutoff=0.001, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
...
pdf(file="heatmap_int_0.05.pdf", height=8, width=19)
uniHeatmap(vsd=vsd,gene.names=gg,
	metric=int$pvalue, # metric of gene significance
	cutoff=0.05, 
	sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
	cex=0.8,
	pdf=F
...
pdf(file="heatmap_int_0.01.pdf", height=2.5, width=7.5)
uniHeatmap(vsd=vsd,gene.names=gg,
           metric=int$pvalue, # metric of gene significance
           cutoff=0.01, 
           sort=c(1:ncol(vsd)),   # overrides sorting of columns according to hierarchical clustering
