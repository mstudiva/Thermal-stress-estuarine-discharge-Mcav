...
pdf(file="KOG_insitu_sym_lpv.pdf", width=7, height=8)
...
pdf(file="KOG_insitu_corr_sym_lpv.pdf", width=7, height=5.2)
par(mfrow=c(1,3))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_insitu_site_sym_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_insitu_site_corr_sym_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_insitu_site_sym_fc.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_insitu_site_corr_sym_fc.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="ledge.south",y="central.south",ktable)
corrPlot(x="ledge.south",y="central.ledge",ktable)
corrPlot(x="central.south",y="central.ledge",ktable)
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_insitu_time_sym_fc.pdf", width=10, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()