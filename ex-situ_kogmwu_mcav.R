...
pdf(file="KOG_exsitu_mcav_lpv.pdf", width=7, height=8)
...
pdf(file="KOG_exsitu_corr_mcav_lpv.pdf", width=7, height=5)
par(mfrow=c(2,3))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_exsitu_tw_mcav_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_exsitu_tw_corr_mcav_lpv.pdf", width=10, height=10)
par(mfrow=c(4,4))
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_exsitu_tw_mcav_fc.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_exsitu_tw_corr_mcav_fc.pdf", width=10, height=10)
par(mfrow=c(4,4))
corrPlot(x="eo.co",y="cd.co",ktable)
corrPlot(x="eo.co",y="ed.co",ktable)
corrPlot(x="eo.co",y="eo.cd",ktable)
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_exsitu_pairwise_mcav_lpv.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_exsitu_pairwise_corr_mcav_lpv.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="eo.co",y="cd.co",ktable)
corrPlot(x="eo.co",y="ed.co",ktable)
corrPlot(x="cd.co",y="ed.co",ktable)
...
# Making a heatmap with hierarchical clustering trees: 
pdf(file="KOG_exsitu_pairwise_mcav_fc.pdf", width=7, height=8)
pheatmap(as.matrix(ktable),clustering_distance_cols="correlation",color=color, cellwidth=15, cellheight=15, border_color="white") 
while (!is.null(dev.list()))  dev.off()

# exploring correlations between datasets
# creating a pub-ready corr plot
pdf(file="KOG_exsitu_pairwise_corr_mcav_fc.pdf", width=7, height=2.5)
par(mfrow=c(1,3))
corrPlot(x="eo.co",y="cd.co",ktable)
corrPlot(x="eo.co",y="ed.co",ktable)
corrPlot(x="cd.co",y="ed.co",ktable)
